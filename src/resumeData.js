let resumeData = {
    ...
    "socialLinks":[
        {
          "name":"linkedin",
          "url":"https://www.linkedin.com/in/aminadab-morales/",
          "className":"fa fa-linkedin"
        },
        {
          "name":"github",
          "url":"https://github.com/aminadabm93",
          "className":"fa fa-github"
        },
        {
          "name":"resume",
          "url":"https://drive.google.com/file/d/1Al0H2awsGgRdp49tU0kYyaLm8mFA6yQB/view",
          "className":"fa fa-file"
        }
      ],
    "aboutme":"Hi all! The journey of my software career began in high school where I studied Java for 2 years and then self-taught Objective-C for a year. Onto college at the University of Texas at Austin where I began as a computer science student while also taking an entry level teaching class. My passion soon switched to teaching and I shifted my studies to physics and math as to become a high school teacher! 3 years later, after countless 60+ hour work weeks, underappreciation, and a less than impressive salary, I am deciding to switch careers to help better my family's and my future. I am a big fan of the logic and algorithms in back-end development, and look forward to cracking jokes and working with a team on some exciting projects. In my off-time I heavily enjoy the outdoors, cooking, and music.",
    "address":"Austin, TX",
    ...
    "work":[
      {
        ...
        "MonthOfLeaving":"June",
        "YearOfLeaving":"2020",
        "Achievements":"Hollyhock fellowship fellow, maker-teacher, PBL presenter "
      }
    ],
    "skillsDescription":"As my about me states, I studied Java for 3 years. The bootcamp covered web development where I gravitated towards the back-end. I self-taught Python and .Net Framework through some projects.",
    "skills":[
      {
        "skillname":"ReactJs"
      },
    ...
    "testimonials":[
      {
        "description":"If you want to go fast, go alone. If you want to go far, gotogether",
        "name":"Proverb"
      },
      {
        "description":"Learning best happens when you feel safe",
        "name":"Me"
      }
    ],
    "mainProjects":[
      {
        ...
        url:"https://chillcubes.herokuapp.com",
        gitUrl:"https://github.com/26rsuarez/chillcubes"
      }
    ]
  }
